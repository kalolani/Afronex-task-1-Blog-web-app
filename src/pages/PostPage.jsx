      ...
      {email && (
        ...
        >
          <textarea
            ...
            className="placeholder:px-4 w-2/3 rounded-sm phone:w-full p-tab:w-9/12 laptop:w-10/12 h-20 border-green-600 focus:outline-green-600 bigdesktop:h-64 bigdesktop:placeholder:text-3xl bigdesktop:placeholder:text-center bigdesktop:text-3xl"
          />
          <div className="mb-16">
